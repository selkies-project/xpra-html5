...
XpraClient.prototype.do_keyb_process = function(pressed, event) {
	...
	// We don't need to send the clipboard on every keyboard
	// capturing the contents on focus should be sufficient
	// if the intent is to copy data from the client browser to the server.
